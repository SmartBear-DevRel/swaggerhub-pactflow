  ...
  return {
    ...
    getAllProducts(
      ...
      const localVarFetchArgs =
        DefaultApiFetchParamCreator(configuration).getAllProducts(options);
      return (fetch: FetchAPI = crossFetch, basePath: string = BASE_PATH) => {
        return fetch(
          basePath + localVarFetchArgs.url,
          localVarFetchArgs.options
...
export const DefaultApiFactory = function (
  ...
  return {
    ...
    getAllProducts(options?: any) {
      return DefaultApiFp(configuration).getAllProducts(options)(
        fetch,
        basePath
      );
    },
    ...
    getProductByID(id: string, options?: any) {
      return DefaultApiFp(configuration).getProductByID(id, options)(
        fetch,
        basePath
      );
    },
...
export class DefaultApi extends BaseAPI {
  ...
  public getAllProducts(options?: any) {
    return DefaultApiFp(this.configuration).getAllProducts(options)(
      this.fetch,
      this.basePath
    );
  }
  ...
  public getProductByID(id: string, options?: any) {
    return DefaultApiFp(this.configuration).getProductByID(id, options)(
      this.fetch,
      this.basePath
    );
  }
